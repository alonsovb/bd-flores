...
% Contiene la descripcion de todas las plantas registradas
% y la lista de los tipos de flores existentes en estos
% registros.
...
tipoFlores([moradas,amarillas,blancas,rojas,rosadas,azules,celestes,no_posee]).
